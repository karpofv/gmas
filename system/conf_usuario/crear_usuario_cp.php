      ...
      ?>
                                <TR style="border-bottom: 1px solid #EEEEEE;">
                                    ...
                                    <TD>
                                        <?php
        if ($permiso_accion['S']==1 AND $permiso_accion['I']==1 AND $permiso_accion['U']==1 AND $permiso_accion['D']==1) { ?>
                                            <a title="Asignar permisos" onclick="$.ajax({ type: 'POST', url: 'busco.php', ajaxSend: $('#verMas').html(cargando),
        ...
        error: function(xhr,msg,excep) { alert('Error Status ' + xhr.status + ': ' + msg + '/ ' + excep); }
                                            ...
                                            <a title="Editar el registro" onclick="$.ajax({ type: 'POST', url: 'busco.php', ajaxSend: $('#page-content').html(cargando),
