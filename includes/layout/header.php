...
<div id="ventanaVer" class="modal fade bs-example-modal-lg"></div>
<div id="sb-site">
    <div id="page-wrapper">
        <div id="page-header" class="clearfix">
            <div id="header-logo" class="rm-transition">
                <a href="#" class="tooltip-button hidden-desktop" title="Navigation Menu" id="responsive-open-menu"> <i class="glyph-icon icon-align-justify"></i> </a> <span>Sistema GMAS <i class="opacity-80">1.0</i>
        </span>
      ...
      <i class="glyph-icon icon-search"></i>
            ...
            <div id="header-right">
                <div class="user-profile dropdown"> <a href="#" title="" class="user-ico clearfix" data-toggle="dropdown">
          ...
          <i class="glyph-icon icon-chevron-down"></i>
                    ...
                    <div class="dropdown-menu pad0B float-right">
                        <div class="box-sm">
                            <div class="login-box clearfix">
                                <div class="user-img"> <a href="#" title="" class="change-img">Change photo</a> <img src="<?php echo $FOTO; ?>" alt=""> </div>
                  ...
                  ?>
                  <i>Perfil</i>
                </span> <a href="#" title="">Cambiar Clave</a> </div>
                            </div>
                ...
                <div class="top-icon-bar float-right" id="notif">
                </div>
            </div>
        </div>
        <!-- #page-header -->